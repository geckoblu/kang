...
class Ui_MainWindowBA(object):
    def setupUi(self, MainWindowBA):
        ...
        self.dotallCheckBox.toggled['bool'].connect(MainWindowBA.checkboxSlot)
        self.editCopyAction.activated.connect(MainWindowBA.editCopy)
        self.editCutAction.activated.connect(MainWindowBA.editCut)
        self.editPasteAction.activated.connect(MainWindowBA.editPaste)
        self.editRedoAction.activated.connect(MainWindowBA.editRedo)
        self.editUndoAction.activated.connect(MainWindowBA.editUndo)
        self.examineAction.activated.connect(MainWindowBA.examine)
        self.fileExitAction.activated.connect(MainWindowBA.close)
        self.fileNewAction.activated.connect(MainWindowBA.fileNew)
        self.fileOpenAction.activated.connect(MainWindowBA.fileOpen)
        self.fileSaveAction.activated.connect(MainWindowBA.fileSave)
        self.fileSaveAsAction.activated.connect(MainWindowBA.fileSaveAs)
        self.helpAboutAction.activated.connect(MainWindowBA.helpAbout)
        self.helpHelpAction.activated.connect(MainWindowBA.helpHelp)
        self.ignorecaseCheckBox.toggled['bool'].connect(MainWindowBA.checkboxSlot)
        self.localeCheckBox.toggled['bool'].connect(MainWindowBA.checkboxSlot)
        self.matchNumberSpinBox.valueChanged['int'].connect(MainWindowBA.matchNumSlot)
        self.multilineCheckBox.toggled['bool'].connect(MainWindowBA.checkboxSlot)
        self.regexMultiLineEdit.textChanged.connect(MainWindowBA.regexChangedSlot)
        self.stringMultiLineEdit.textChanged.connect(MainWindowBA.stringChangedSlot)
        self.unicodeCheckBox.toggled['bool'].connect(MainWindowBA.checkboxSlot)
        self.verboseCheckBox.toggled['bool'].connect(MainWindowBA.checkboxSlot)
        self.editPauseAction.toggled['bool'].connect(MainWindowBA.pause)
        self.editPreferencesAction.activated.connect(MainWindowBA.editPreferences)
        self.helpPythonHelpAction.activated.connect(MainWindowBA.helpPythonRegex)
        self.helpRegexReferenceAction.activated.connect(MainWindowBA.referenceGuide)
        self.helpVisitWebsiteAction.activated.connect(MainWindowBA.helpVisitKangWebsite)
        self.replaceTextEdit.textChanged.connect(MainWindowBA.replaceChangedSlot)
        self.replaceNumberSpinBox.valueChanged['int'].connect(MainWindowBA.replaceNumSlot)
        self.fileImportFileAction.activated.connect(MainWindowBA.importFile)
        self.fileImportURLAction.activated.connect(MainWindowBA.importURL)
        self.helpRegexLibAction.activated.connect(MainWindowBA.helpRegexLib)
        self.regexMultiLineEdit.textChanged.connect(MainWindowBA.edited)
        self.stringMultiLineEdit.textChanged.connect(MainWindowBA.edited)
        self.ignorecaseCheckBox.toggled['bool'].connect(MainWindowBA.edited)
        self.replaceTextEdit.textChanged.connect(MainWindowBA.edited)
        self.multilineCheckBox.toggled['bool'].connect(MainWindowBA.edited)
        self.dotallCheckBox.toggled['bool'].connect(MainWindowBA.edited)
        self.verboseCheckBox.toggled['bool'].connect(MainWindowBA.edited)
        self.localeCheckBox.toggled['bool'].connect(MainWindowBA.edited)
        self.unicodeCheckBox.toggled['bool'].connect(MainWindowBA.edited)
        self.fileRevertAction.activated.connect(MainWindowBA.fileRevert)
