...
class Ui_MainWindowBA(object):
    def setupUi(self, MainWindowBA):
        ...
        QObject.connect(self.regexMultiLineEdit, SIGNAL(_fromUtf8("textChanged()")), MainWindowBA._edited)
        QObject.connect(self.stringMultiLineEdit, SIGNAL(_fromUtf8("textChanged()")), MainWindowBA._edited)
        QObject.connect(self.ignorecaseCheckBox, SIGNAL(_fromUtf8("toggled(bool)")), MainWindowBA._edited)
        QObject.connect(self.replaceTextEdit, SIGNAL(_fromUtf8("textChanged()")), MainWindowBA._edited)
        QObject.connect(self.multilineCheckBox, SIGNAL(_fromUtf8("toggled(bool)")), MainWindowBA._edited)
        QObject.connect(self.dotallCheckBox, SIGNAL(_fromUtf8("toggled(bool)")), MainWindowBA._edited)
        QObject.connect(self.verboseCheckBox, SIGNAL(_fromUtf8("toggled(bool)")), MainWindowBA._edited)
        QObject.connect(self.localeCheckBox, SIGNAL(_fromUtf8("toggled(bool)")), MainWindowBA._edited)
        QObject.connect(self.asciiCheckBox, SIGNAL(_fromUtf8("toggled(bool)")), MainWindowBA._edited)
