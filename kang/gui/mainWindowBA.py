...
class Ui_MainWindowBA(object):
    def setupUi(self, MainWindowBA):
        ...
        self.asciiCheckBox = QCheckBox(self.groupBox2)
        self.asciiCheckBox.setObjectName(_fromUtf8("asciiCheckBox"))
        self.hboxlayout.addWidget(self.asciiCheckBox)
        ...
        QObject.connect(self.matchNumberSpinBox, SIGNAL(_fromUtf8("valueChanged(int)")), MainWindowBA._matchNumberChanged)
        ...
        QObject.connect(self.asciiCheckBox, SIGNAL(_fromUtf8("toggled(bool)")), MainWindowBA.checkboxSlot)
        ...
        QObject.connect(self.replaceNumberSpinBox, SIGNAL(_fromUtf8("valueChanged(int)")), MainWindowBA._replaceNumberChanged)
        ...
        QObject.connect(self.regexMultiLineEdit, SIGNAL(_fromUtf8("textChanged()")), MainWindowBA._modified)
        QObject.connect(self.stringMultiLineEdit, SIGNAL(_fromUtf8("textChanged()")), MainWindowBA._modified)
        QObject.connect(self.ignorecaseCheckBox, SIGNAL(_fromUtf8("toggled(bool)")), MainWindowBA._modified)
        QObject.connect(self.replaceTextEdit, SIGNAL(_fromUtf8("textChanged()")), MainWindowBA._modified)
        QObject.connect(self.multilineCheckBox, SIGNAL(_fromUtf8("toggled(bool)")), MainWindowBA._modified)
        QObject.connect(self.dotallCheckBox, SIGNAL(_fromUtf8("toggled(bool)")), MainWindowBA._modified)
        QObject.connect(self.verboseCheckBox, SIGNAL(_fromUtf8("toggled(bool)")), MainWindowBA._modified)
        QObject.connect(self.localeCheckBox, SIGNAL(_fromUtf8("toggled(bool)")), MainWindowBA._modified)
        QObject.connect(self.asciiCheckBox, SIGNAL(_fromUtf8("toggled(bool)")), MainWindowBA._modified)
        ...
        MainWindowBA.setTabOrder(self.localeCheckBox, self.asciiCheckBox)
        MainWindowBA.setTabOrder(self.asciiCheckBox, self.matchNumberSpinBox)
...
"such \"#\" through the end of the line are ignored.", None))
        ...
        self.asciiCheckBox.setToolTip(_translate("MainWindowBA", "\"Make \\w, \\W, \\b, and \\B dependent on the Unicode character properties \n"
"database. New in Python version 2.0.", None))
        self.asciiCheckBox.setText(_translate("MainWindowBA", "Unicode", None))
